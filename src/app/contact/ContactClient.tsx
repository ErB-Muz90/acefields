      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {[
              { icon: "📞", title: "Nairobi HQ", info: "+254 725 306 678\nMombasa Road, Industrial Area", action: "tel:+254725306678" },
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              {/* Nairobi HQ */}
              <div className="p-6 bg-surface rounded-2xl border border-gray-100 mb-4">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center text-2xl shrink-0">🏢</div>
                  <div className="flex-1">
                    <h3 className="font-bold text-lg text-primary">Nairobi HQ</h3>
                    <p className="text-text-secondary text-sm mt-1">Mombasa Road, Industrial Area<br />Nairobi, Kenya</p>
                    <p className="text-text-primary font-semibold mt-2">📞 +254 725 306 678</p>
                    <a
                      href="https://maps.google.com/?q=-1.3124,36.8475"
                      target="_blank"
